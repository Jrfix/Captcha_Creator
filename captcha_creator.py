...
def create():
	...
	t1 = c.create_text(40+r.randint(0,10),40+r.randint(0,10),text=h[0],font=myFont1,fill= color[r.randint(0,8)],angle=r.randint(-30,30))
	t2 = c.create_text(80+r.randint(0,10),40+r.randint(0,10),text=h[1],font=myFont2,fill= color[r.randint(0,8)],angle=r.randint(-30,30))
	t3 = c.create_text(120+r.randint(0,10),40+r.randint(0,10),text=h[2],font=myFont3,fill= color[r.randint(0,8)],angle=r.randint(-30,30))
	t4 = c.create_text(160+r.randint(0,10),40+r.randint(0,10),text=h[3],font=myFont4,fill= color[r.randint(0,8)],angle=r.randint(-30,30))
	t5 = c.create_text(200+r.randint(0,10),40+r.randint(0,10),text=h[4],font=myFont5,fill= color[r.randint(0,8)],angle=r.randint(-30,30))
